...
room = {
    ...
    'foyer':    Room("Foyer",
                    ...
                    What would you like to do? (N to go north, S to go south, E to go east, W to go west, I to investigate the room, IN to view your inventory, USE to use an item, DROP to drop an item, H for a hint, Q to quit)"""),
